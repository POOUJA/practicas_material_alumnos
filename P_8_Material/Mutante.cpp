...
void Mutante::addPoder(const PoderFisico& poder) {
    if (_numPoderes >= MAX_PODERES) {
        throw std::length_error("Mutante::addPoder(PoderFisico): el mutante no admite más dones");
    }
...
void Mutante::addPoder(const PoderPsiquico& poder) {
    if (_numPoderes >= MAX_PODERES) {
        throw std::length_error("Mutante::addPoder(PoderPsiquico): el mutante no admite más dones");
    }
